...
const statusIcons = {
  ...
  refunded: <AlertCircle className="w-5 h-5 text-slate-600 dark:text-slate-400" />
};
...
const statusColors = {
  ...
  refunded: 'bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200'
};
          ...
          <AnimatePresence>
            {payments.map((payment, idx) => (
              <motion.div
                ...
                className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-colors"
              >
