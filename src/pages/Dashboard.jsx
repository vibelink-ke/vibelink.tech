          ...
          >
            ...
            <div className="space-y-3">
              {tickets.slice(0, 5).map((ticket, i) => (
                <div key={ticket.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50">
                  <div className="flex items-center gap-3">
          ...
          >
            ...
            <div className="space-y-3">
              {logs.slice(0, 5).map((log, i) => (
                <div key={log.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50">
