...
const COLLECTIONS = {
  ...
  inventory: [
    { id: 'inv1', tracking: 'serialized', name: 'TP-Link CPE210', category: 'CPE', mac_address: 'AA:BB:CC:DD:EE:01', serial_number: null, owned_by_tenant: true, subscriber_id: 'c1', subscriber_name: 'John Kamau', subscriber_account_code: '44013', router_id: null, router_name: null, status: 'installed', notes: null, quantity: 1, unit: null, created_at: iso(-5) },
    { id: 'inv2', tracking: 'bulk', name: 'CAT6 cable', category: 'Cable', mac_address: null, serial_number: null, owned_by_tenant: true, subscriber_id: null, subscriber_name: null, subscriber_account_code: null, router_id: null, router_name: null, status: 'in_stock', notes: null, quantity: 120, unit: 'meters', created_at: iso(-5) },
  ],
