...
export const api = {
  ...
  platformOrgBalance: () => get('/api/platform/org-balance'),
  refreshPlatformOrgBalance: () => post('/api/platform/org-balance/refresh', {}),
  ...
  smartoltVlans: (oltId) => get(`/api/smartolt/vlans/${encodeURIComponent(oltId)}`),
  smartoltProvision: (id) => get(`/api/smartolt/provision/${encodeURIComponent(id)}`),
